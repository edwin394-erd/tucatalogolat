...
<div class="p-4 md:p-5 bg-white md:m-5 rounded-lg md:w-1/2" >
  ...
  <form class="p-4 md:p-5" wire:submit.prevent="save" novalidate>
     <div>
        ...
        <input type="email" wire:model.blur="plan" name="plan" id="plan" class="bg-gray-100 inset-shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="{{ __('messages.plan') }}" required="">
        @error('plan')
    ...
    <div>
        ...
        <input type="telephone" wire:model="telefono" name="telephone" id="telephone" class="bg-gray-100 inset-shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="{{ __('messages.telephone') }}" required="">
        @error('telephone')
                <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
    </div>
...
<div class="flex gap-3">
        ...
        <div class="w-1/2">
                ...
                <input type="new_password" wire:model.blur="new_password" name="new_password" id="new_password" placeholder="••••••••" class="bg-gray-100 inset-shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required="">
                @error('new_password')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
        </div>
