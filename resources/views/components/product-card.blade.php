            ...
            <div class="p-3 md:p-6 flex flex-col flex-1">
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mt-auto gap-2">
                    ...
                    <div class="flex gap-1 md:gap-2 w-full sm:w-auto">
                        ...
                        <button type="button" x-data="{ added: false }" @click="added = true; setTimeout(() => added = false, 500)" wire:click="addToCart({{ $item->id }})" :class="added ? 'scale-125 shadow-2xl ring-4 ring-white/80 animate-pulse' : ''" class="flex-1 sm:flex-none p-2 md:p-3 rounded-xl text-white shadow-md transition-all duration-200 ease-out active:scale-95 flex justify-center items-center" 
